...
namespace NotifyRipe.Core
{
    ...
    public class NotifyRipeMod : Mod
    {
        public NotifyRipeMod(ModContentPack content) : base(content)
        {
            Log.Message("[NotifyRipe] Loaded (scaffold - no behaviour yet).");
        }
    }
}
